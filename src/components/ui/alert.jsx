...
const Alert = React.forwardRef(({ variant = "default", className, onComplete, onPostpone, ...props }, ref) => {
  const variantStyles = {
...
const AlertDescription = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "p-3 text-sm font-mono [&_p]:leading-relaxed",
      className
    )}
    {...props}
  />
...
const AlertFooter = React.forwardRef(({ className, onComplete, onPostpone, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
